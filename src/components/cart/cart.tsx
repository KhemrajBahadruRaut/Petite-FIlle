  ...
  if (!isHydrated) {
    return (
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="min-h-screen bg-gradient-to-b from-amber-50 to-stone-100 py-12"
      >
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-gray-100 text-black rounded-full px-3 py-2">
                ...
                <motion.span 
                  ...
                  initial={{ scale: 1.2 }}
                  animate={{ scale: 1 }}
                  className="font-medium text-sm min-w-[20px] text-center"
                >
                  {item.quantity}
                </motion.span>
                <motion.button
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-light text-gray-800" style={{ fontFamily: 'fairplaybold' }}>Your Cart</h1>
              <motion.p 
                key={totalItems}
                initial={{ scale: 1.1 }}
                animate={{ scale: 1 }}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {merchItems.length > 0 && (
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><path fill="currentColor" d="M16 21H8a1 1 0 0 1-1-1v-7.93l-1.3 1.05c-.39.38-1.02.38-1.41 0l-2.83-2.83a.996.996 0 0 1 0-1.41L7.34 3H9c0 1.1 1 3 3 4.25C14 6 15 4.1 15 3h1.66l5.88 5.88c.39.39.39 1.02 0 1.41l-2.83 2.83c-.39.38-1.02.38-1.41 0L17 12.07V20a1 1 0 0 1-1 1m4.42-11.42l-4.31-4.3C15 7 14 8.25 12 9.25c-2-1-3-2.25-4.11-3.97l-4.31 4.3L5 11l3-2h1v10h6V9h1l3 2z"/></svg></div>
                    <h2 className="text-xl text-gray-800" style={{ fontFamily: 'fairplay' }}>
