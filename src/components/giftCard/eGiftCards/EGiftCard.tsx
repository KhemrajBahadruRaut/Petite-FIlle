    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-lg w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Get a voucher for yourself or gift one to a friend</p>
        </div>
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            {/* Bow decoration */}
            <div className="absolute -top-2 -left-2 w-12 h-12 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center shadow-md">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="recipient" className="block text-gray-700 font-medium mb-2">To:</label>
                <input
                  id="recipient"
                  type="text"
                  value={formData.recipient}
                  onChange={(e) => handleInputChange('recipient', e.target.value)}
                  className={`w-full px-0 py-2 border-0 border-b-2 bg-transparent focus:outline-none transition-colors ${
                    errors.recipient 
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full px-0 py-2 border-0 border-b-2 bg-transparent focus:outline-none resize-none transition-colors ${
                    errors.message 
                      ? 'border-red-500 focus:border-red-500' 
                      : 'border-gray-300 focus:border-amber-500'
                  }`}
          ...
          {/* Quantity */}
          <div>
            <label className="block text-amber-800 font-medium mb-3">Quantity: *</label>
            <div className="flex items-center space-x-4">
              ...
              <input
                ...
                min="1"
                max="10"
                className="w-16 h-10 text-center border border-gray-300 rounded-lg focus:outline-none focus:border-amber-500"
              />
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="senderName" className="block text-gray-700 font-medium mb-2">From: *</label>
                <input
                  id="senderName"
                  type="text"
              ...
              <div>
                <label htmlFor="senderEmail" className="block text-gray-700 font-medium mb-2">Email: *</label>
                <input
                  id="senderEmail"
                  type="email"
